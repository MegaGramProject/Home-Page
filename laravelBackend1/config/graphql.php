...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'getBasicInfoOnUser' => App\GraphQL\Queries\User\GetBasicInfoOnUser::class,
                'getBasicInfoOnMultipleUsers' => App\GraphQL\Queries\User\GetBasicInfoOnMultipleUsers::class,
            ...
            'mutation' => [
                'deleteOwnAccount' => App\GraphQL\Mutations\User\DeleteOwnAccount::class
            ],

            'types' => [
                'basicUserInfo' => App\GraphQL\Types\User\Outputs\BasicUserInfo::class,
                'inDepthUserInfo' => App\GraphQL\Types\User\Outputs\InDepthUserInfo::class
            ],
