<template>
    <nav>
      <div class="menu">
        <a
          href="http://34.111.89.101/vuejs-hp/"
          class="website_name"
          style="font-family: Billabong; font-size: 3em; background-color: white; color: black;"
        >
          Megagram
        </a>
  
        <a href="http://34.111.89.101/vuejs-hp/">
          <img
            :src="favicon1"
        ...
        <a href="http://34.111.89.101/vuejs-hp/">
          <img
            :src="megagramLoading"
            style="height: 7em; width: 7em; margin-top: 2em; cursor: pointer;"
          />
        </a>
      </div>
    </nav>
    ...
    <section class="wrapper">
      <div class="container">
        <div ref="sceneRef" class="scene" data-hover-only="false">
        ...
        <div class="text">
          <article>
            <p>
              ...
              <br />
              Go to the VueJS home-page if that's what you were looking for & you dare!
            </p>
            <a href="http://34.111.89.101/vuejs-hp/">
              <button>I dare!</button>
            </a>
            <p
              style="position: absolute; top: 150%; color: white; font-size: 0.68em;"
            >
              Credit to
              <a
                href="https://rafaelalucas.com/"
                target="_blank"
...
<style>
  ...
  @font-face {
    ...
    src: url("../assets/fonts/billabong_regular.otf");
    font-weight: normal;
    font-style: normal;
  }
</style>
...
<style scoped>
  .neonText {
    color: white;
    text-shadow: 0 0 7px white, 0 0 10px red, 0 0 21px red, 0 0 42px red, 0 0 82px red, 0 0 92px red, 0 0 102px red, 0 0 151px red, 0 0 200px red;
  }
