...
function ErrorPopup({errorMessage, notifyParentToClosePopup}) {
    ...
    return (
        ...
        overflowY: 'scroll'}}>
            ...
            <div style={{backgroundColor: 'white', display:'flex', justifyContent: 'center', position: 'relative',
            ...
            paddingBottom: '1em'}}>
                <b style={{fontSize: '1.25em', color: '#ff0f23'}}>Error</b>
            ...
            maxWidth: '75%', overflowWrap: 'break-word', fontSize: '1em', color: 'gray'}}>
                {errorMessage}
            </p>
