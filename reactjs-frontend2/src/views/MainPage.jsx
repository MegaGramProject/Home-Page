...
class MainPage extends Component {
    constructor(props) {
        ...
        this.closeAnyPopup = this.closeAnyPopup.bind(this);
        this.toggleDisplayLeftSidebarPopup = this.toggleDisplayLeftSidebarPopup.bind(this);
    };
    ...
    toggleDisplayLeftSidebarPopup() {
        this.setState({
            displayLeftSidebarPopup: !this.state.displayLeftSidebarPopup
        });
    }
            ...
            {4==4 &&
                <div>
                    <div style={{display:'flex', justifyContent:'space-between', alignItems:'start'}}>
                        <LeftSidebar username={this.state.username} displayPopup={this.state.displayLeftSidebarPopup}
                        toggleDisplayPopup={this.toggleDisplayLeftSidebarPopup}/>
                    ...
                    {this.state.displayLeftSidebarPopup &&
                        <LeftSidebarPopup username={this.state.username}/>
                    }

                    {(this.state.showThreeDotsPopup || this.state.showCommentsPopup ||  this.state.showSendPostPopup || 
                    this.state.showPostLikersPopup || this.state.showAboutAccountPopup) && (
                        <img onClick={this.closeAnyPopup} src={blackScreen} style={{position: 'absolute', 
