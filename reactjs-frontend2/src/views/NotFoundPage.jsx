                    ...
                    <div ref={sceneRef} className="scene" data-hover-only="false">
                        ...
                        <div className="one" data-depth="0.9">
                            <div className="content">
                                <span className="piece neonText" style={{ padding: '0.5em 1em' }}>WE</span>
                                <span className="piece neonText" style={{ padding: '0.5em 1em' }}>GOT LOST</span>
                                <span className="piece neonText" style={{ padding: '0.5em 1em' }}>TOO!</span>
                            </div>
                        </div>
